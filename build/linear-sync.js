...
import { updateTaskList as updateTaskList, registerSendListener, } from "./telegram.js";
...
registerSendListener(async (message, method) => {
    ...
    const generalTaskList = (_b = (_a = tasklists === null || tasklists === void 0 ? void 0 : tasklists.data) === null || _a === void 0 ? void 0 : _a.items) === null || _b === void 0 ? void 0 : _b.find((tasklist) => tasklist.title === "General"), generalTaskListId = generalTaskList === null || generalTaskList === void 0 ? void 0 : generalTaskList.id;
    if (method == "add") {
        // new task
    ...
    if (method == "done") {
        ...
        const generalTasks = await tasks.tasks.list({
            tasklist: generalTaskListId,
        }), generalTasksData = (_c = generalTasks === null || generalTasks === void 0 ? void 0 : generalTasks.data) === null || _c === void 0 ? void 0 : _c.items;
        // find one with the id
        const task = generalTasksData === null || generalTasksData === void 0 ? void 0 : generalTasksData.find((task) => task.id === message);
        if (!task) {
        ...
        await tasks.tasks.update({
            tasklist: generalTaskListId,
            task: method,
            requestBody: Object.assign(Object.assign({}, task), { status: "completed" }),
        });
        // send the tasklist again
        await updateTaskListInTelegram(generalTaskListId);
        return;
...
async function updateTaskListInTelegram(generalTaskListId) {
    var _a;
    const generalTasks = await tasks.tasks.list({
        tasklist: generalTaskListId,
    }), generalTasksData = (_a = generalTasks === null || generalTasks === void 0 ? void 0 : generalTasks.data) === null || _a === void 0 ? void 0 : _a.items;
    // get not completed tasks
    const notCompletedTasks = generalTasksData === null || generalTasksData === void 0 ? void 0 : generalTasksData.filter((task) => task.status !== "completed");
    // generate task list
    const taskList = notCompletedTasks === null || notCompletedTasks === void 0 ? void 0 : notCompletedTasks.map((task) => `${task.title}\n/t${task.id}`).join("\n\n");
    // escape markdown in tasklist
    const escapeMarkdown = (text) => {
        // including dash
        return text.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&");
    };
    updateTaskList(`*${notCompletedTasks === null || notCompletedTasks === void 0 ? void 0 : notCompletedTasks.length} /tasks*\n\n` + escapeMarkdown(taskList || ""));
}
async function task() {
    var _a, _b, _c;
    log("Starting task");
    ...
    log("Google - got " + (generalTasksData === null || generalTasksData === void 0 ? void 0 : generalTasksData.length) + " tasks in General task list");
    ...
    moment(issue.updatedAt).isAfter(moment().subtract(2, "weeks")) &&
        ...
        !issue.snoozedBy &&
        // not done
        !(issue === null || issue === void 0 ? void 0 : issue.completedAt))
        .map((issue) => ({
    ...
    (issue) => !(generalTasksData === null || generalTasksData === void 0 ? void 0 : generalTasksData.find((task) => { var _a; return (_a = task === null || task === void 0 ? void 0 : task.title) === null || _a === void 0 ? void 0 : _a.includes(issue.identifier); })));
